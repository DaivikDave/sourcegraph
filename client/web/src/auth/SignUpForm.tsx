...
import { maybeAddPostSignUpRedirect, PasswordInput, UsernameInput, SignupEmailField } from './SignInSignUpCommon'
...
export const SignUpForm: React.FunctionComponent<SignUpFormProps> = ({
    ...
    const onClickExternalAuthSignup = useCallback(
        (serviceType: string): React.MouseEventHandler<HTMLAnchorElement> => () => {
            ...
            eventLogger.log('SignupInitiated', { type: serviceType }, { type: serviceType })
        },
        []
    )
    return (
